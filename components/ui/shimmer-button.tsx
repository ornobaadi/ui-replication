  ...
  (
    ...
    return (
      <button
        ...
        {...props}
      >
        {/* spark container — hidden at rest, animated only on hover */}
        <div
          className={cn(
            "-z-30 blur-[2px]",
        ...
        >
          {/* spark */}
          <div className="group-hover:animate-shimmer-slide absolute inset-0 [aspect-ratio:1] h-[100cqh] [border-radius:0] [mask:none]">
            {/* spark before */}
        ...
        {/* Highlight — no glow at rest, glows only on hover */}
        <div
          className={cn(
            "absolute inset-0 size-full",

            "rounded-2xl px-4 py-1.5 text-sm font-medium shadow-none",
